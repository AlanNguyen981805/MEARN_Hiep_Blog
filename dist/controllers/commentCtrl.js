...
const commentCtrl = {
    createComment: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const data = Object.assign(Object.assign({}, newComment._doc), { user: req.user, createAt: new Date().toISOString() });
    ...
    replyComment: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const data = Object.assign(Object.assign({}, newComment._doc), { user: req.user, reply_user: reply_user, createAt: new Date().toISOString() });
